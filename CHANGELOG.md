...
## [1.0.0] - 2026-03-04
### Release Highlights
- End-to-end analytics workflow with recruiter-focused documentation.
- Practical engineering quality gates (lint, tests, coverage, contracts).
- Architecture evidence package (ADR + data contract + lineage controls).
- Demo: https://data-analytics-sr.streamlit.app

### Added
- Recruiter-focused README upgrades: project summary, impact section, architecture links, and demo screenshots.
